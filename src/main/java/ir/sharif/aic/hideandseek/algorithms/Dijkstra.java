...
//                        System.out.println("printing before here: " + nodes[id].before.id);
                ...
                finished_nodes.add(unfinished_nodes.get(0)); // todo " Index 0 out of bounds for length 0"
...
//        }
            ...
            System.out.println("went through an exception in DIJKSTRA, so i stay in my place.");
            ArrayList<Integer> alternative_ans = new ArrayList<>();
            alternative_ans.add(src);
            alternative_ans.add(src);
            alternative_ans.add(src);
            return alternative_ans;
        }
    }
}
